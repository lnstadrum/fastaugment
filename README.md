...
Common image preprocessing and data augmentation scripts involve plenty processing blocks run on CPU. Depending on the hardware, this can turn the CPU load and RAM bandwidth into a bottleneck and cause GPU being underutilized.
